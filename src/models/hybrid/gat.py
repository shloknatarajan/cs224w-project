"""
Hybrid GAT: Structure-only encoder + Chemistry-aware decoder
"""
import torch
...
class HybridGAT(nn.Module):
    """
    Hybrid GAT with structure-only encoder and chemistry-aware decoder.
    """
    ...
    def __init__(self,
        ...
        self.description = (
            f"Hybrid-GAT ({num_layers} layers, {num_heads} heads, dropout={dropout}) | "
    ...
    def encode(self, edge_index, x=None):
        """Encode nodes using structure-only GAT."""

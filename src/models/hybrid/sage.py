"""
Hybrid GraphSAGE: Structure-only encoder + Chemistry-aware decoder
"""
import torch
...
class HybridGraphSAGE(nn.Module):
    """
    Hybrid GraphSAGE with structure-only encoder and chemistry-aware decoder.
    """
    ...
    def __init__(self,
        ...
        self.description = (
            f"Hybrid-GraphSAGE ({num_layers} layers, dropout={dropout}) | "
    ...
    def encode(self, edge_index, x=None):
        """Encode nodes using structure-only GraphSAGE."""

"""
Variant 2: Add BatchNorm
- 2 layers
- YES BatchNorm (NEW)
- dropout=0.0

Hypothesis: BatchNorm may stabilize training and improve generalization
"""
import torch
...
class SAGEVariant2BatchNorm(BaseModel):
    """GraphSAGE with BatchNorm added"""
    ...
    def __init__(self, num_nodes, hidden_dim=128, decoder_dropout=0.0, use_multi_strategy=False):
        ...
        self.description = (
            f"SAGE-V2-BatchNorm (2L, BN✓, drop=0.0) | "
        ...
        # GraphSAGE layers with BatchNorm
